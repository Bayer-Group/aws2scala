...
object Instance {
  ...
  /** Describes an EBS volume in a block device mapping.
    ...
    */
  case class BlockDevice(volumeId: String,
  ...
  /** Describes a network interface.
    ...
    */
  case class NetworkInterface(id: String,
                              subnetId: String,
                              vpcId: String,
  ...
  object NetworkInterface {
    ...
    /** Describes association information for an elastic IP address.
      ...
      */
    case class Association(ipOwner: String,
                           publicDnsName: Option[String],
                           publicIp: String)
    object Association {
    ...
    /** Describes a private IP address.
      ...
      */
    case class PrivateIpAddress(privateIpAddress: String,
                                privateDnsName: Option[String],
                                primary: Boolean,
