...
import com.monsanto.arch.awsutil.test._
...
class EC2ClientIntegrationSpec extends FreeSpec with AwsIntegrationSpec with StrictLogging with IntegrationCleanup {
  val streamingEC2 = streamingAwsClient.ec2
  val asyncEC2 = asyncAwsClient.ec2

  val streamingCloudFormation = streamingAwsClient.cloudFormation
  val asyncCloudFormation = asyncAwsClient.cloudFormation
