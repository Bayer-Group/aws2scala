...
import com.monsanto.arch.awsutil.{AwsSettings, DefaultStreamingAwsClient}
...
trait AwsIntegrationSpec extends BeforeAndAfterAll { this: Suite ⇒
  ...
  protected val streamingAwsClient = new DefaultStreamingAwsClient(AwsSettings.Default)
