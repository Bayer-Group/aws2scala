...
trait AsyncSNSClient {
  ...
  /** Sends a message to a mobile endpoint or to all of a topic’s subscribed endpoints.
    ...
    * @return the unique identifier of the published message
    */
  def publish(targetArn: String, message: String, attributes: Map[String,MessageAttributeValue[_]])
             (implicit m: Materializer): Future[String]
  ...
  /** Sends a message to a mobile endpoint or to all of a topic’s subscribed endpoints.
    ...
    * @return the unique identifier of the published message
    */
  def publish(targetArn: String, message: String, subject: String, attributes: Map[String,MessageAttributeValue[_]])
             (implicit m: Materializer): Future[String]
  ...
  /** Sends a message to a mobile endpoint or to all of a topic’s subscribed endpoints.  This variation allows sending
    ...
    * @return the unique identifier of the published message
    */
  def publish(targetArn: String, message: Map[String,String], attributes: Map[String,MessageAttributeValue[_]])
             (implicit m: Materializer): Future[String]
  ...
  /** Sends a message to a mobile endpoint or to all of a topic’s subscribed endpoints.  This variation allows sending
    ...
    */
  def publish(targetArn: String, message: Map[String,String], subject: String,
              attributes: Map[String,MessageAttributeValue[_]])
             (implicit m: Materializer): Future[String]
}
