...
object PublishRequest {
  ...
  def apply(targetArn: String, message: String, attributes: Map[String,MessageAttributeValue[_]]): PublishRequest =
  ...
  def apply(targetArn: String, message: String, subject: String,
            attributes: Map[String,MessageAttributeValue[_]]): PublishRequest =
