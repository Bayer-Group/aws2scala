...
sealed trait IdentityManagementAction extends Action
...
object IdentityManagementAction {
  ...
  case object AddRoleToInstanceProfile extends IdentityManagementAction

  /** Action for the AddUserToGroup operation. */
  case object AddUserToGroup extends IdentityManagementAction

  /** Action for the ChangePassword operation. */
  case object ChangePassword extends IdentityManagementAction

  /** Action for the CreateAccessKey operation. */
  case object CreateAccessKey extends IdentityManagementAction

  /** Action for the CreateAccountAlias operation. */
  case object CreateAccountAlias extends IdentityManagementAction

  /** Action for the CreateGroup operation. */
  case object CreateGroup extends IdentityManagementAction

  /** Action for the CreateInstanceProfile operation. */
  case object CreateInstanceProfile extends IdentityManagementAction

  /** Action for the CreateLoginProfile operation. */
  case object CreateLoginProfile extends IdentityManagementAction

  /** Action for the CreateRole operation. */
  case object CreateRole extends IdentityManagementAction

  /** Action for the CreateUser operation. */
  case object CreateUser extends IdentityManagementAction

  /** Action for the CreateVirtualMFADevice operation. */
  case object CreateVirtualMFADevice extends IdentityManagementAction

  /** Action for the DeactivateMFADevice operation. */
  case object DeactivateMFADevice extends IdentityManagementAction

  /** Action for the DeleteAccessKey operation. */
  case object DeleteAccessKey extends IdentityManagementAction

  /** Action for the DeleteAccountAlias operation. */
  case object DeleteAccountAlias extends IdentityManagementAction

  /** Action for the DeleteAccountPasswordPolicy operation. */
  case object DeleteAccountPasswordPolicy extends IdentityManagementAction

  /** Action for the DeleteGroup operation. */
  case object DeleteGroup extends IdentityManagementAction

  /** Action for the DeleteGroupPolicy operation. */
  case object DeleteGroupPolicy extends IdentityManagementAction

  /** Action for the DeleteInstanceProfile operation. */
  case object DeleteInstanceProfile extends IdentityManagementAction

  /** Action for the DeleteLoginProfile operation. */
  case object DeleteLoginProfile extends IdentityManagementAction

  /** Action for the DeleteRole operation. */
  case object DeleteRole extends IdentityManagementAction

  /** Action for the DeleteRolePolicy operation. */
  case object DeleteRolePolicy extends IdentityManagementAction

  /** Action for the DeleteServerCertificate operation. */
  case object DeleteServerCertificate extends IdentityManagementAction

  /** Action for the DeleteSigningCertificate operation. */
  case object DeleteSigningCertificate extends IdentityManagementAction

  /** Action for the DeleteUser operation. */
  case object DeleteUser extends IdentityManagementAction

  /** Action for the DeleteUserPolicy operation. */
  case object DeleteUserPolicy extends IdentityManagementAction

  /** Action for the DeleteVirtualMFADevice operation. */
  case object DeleteVirtualMFADevice extends IdentityManagementAction

  /** Action for the EnableMFADevice operation. */
  case object EnableMFADevice extends IdentityManagementAction

  /** Action for the GetAccountPasswordPolicy operation. */
  case object GetAccountPasswordPolicy extends IdentityManagementAction

  /** Action for the GetAccountSummary operation. */
  case object GetAccountSummary extends IdentityManagementAction

  /** Action for the GetGroup operation. */
  case object GetGroup extends IdentityManagementAction

  /** Action for the GetGroupPolicy operation. */
  case object GetGroupPolicy extends IdentityManagementAction

  /** Action for the GetInstanceProfile operation. */
  case object GetInstanceProfile extends IdentityManagementAction

  /** Action for the GetLoginProfile operation. */
  case object GetLoginProfile extends IdentityManagementAction

  /** Action for the GetRole operation. */
  case object GetRole extends IdentityManagementAction

  /** Action for the GetRolePolicy operation. */
  case object GetRolePolicy extends IdentityManagementAction

  /** Action for the GetServerCertificate operation. */
  case object GetServerCertificate extends IdentityManagementAction

  /** Action for the GetUser operation. */
  case object GetUser extends IdentityManagementAction

  /** Action for the GetUserPolicy operation. */
  case object GetUserPolicy extends IdentityManagementAction

  /** Action for the ListAccessKeys operation. */
  case object ListAccessKeys extends IdentityManagementAction

  /** Action for the ListAccountAliases operation. */
  case object ListAccountAliases extends IdentityManagementAction

  /** Action for the ListGroupPolicies operation. */
  case object ListGroupPolicies extends IdentityManagementAction

  /** Action for the ListGroups operation. */
  case object ListGroups extends IdentityManagementAction

  /** Action for the ListGroupsForUser operation. */
  case object ListGroupsForUser extends IdentityManagementAction

  /** Action for the ListInstanceProfiles operation. */
  case object ListInstanceProfiles extends IdentityManagementAction

  /** Action for the ListInstanceProfilesForRole operation. */
  case object ListInstanceProfilesForRole extends IdentityManagementAction

  /** Action for the ListMFADevices operation. */
  case object ListMFADevices extends IdentityManagementAction

  /** Action for the ListRolePolicies operation. */
  case object ListRolePolicies extends IdentityManagementAction

  /** Action for the ListRoles operation. */
  case object ListRoles extends IdentityManagementAction

  /** Action for the ListServerCertificates operation. */
  case object ListServerCertificates extends IdentityManagementAction

  /** Action for the ListSigningCertificates operation. */
  case object ListSigningCertificates extends IdentityManagementAction

  /** Action for the ListUserPolicies operation. */
  case object ListUserPolicies extends IdentityManagementAction

  /** Action for the ListUsers operation. */
  case object ListUsers extends IdentityManagementAction

  /** Action for the ListVirtualMFADevices operation. */
  case object ListVirtualMFADevices extends IdentityManagementAction

  /** Action for the PassRole operation. */
  case object PassRole extends IdentityManagementAction

  /** Action for the PutGroupPolicy operation. */
  case object PutGroupPolicy extends IdentityManagementAction

  /** Action for the PutRolePolicy operation. */
  case object PutRolePolicy extends IdentityManagementAction

  /** Action for the PutUserPolicy operation. */
  case object PutUserPolicy extends IdentityManagementAction

  /** Action for the RemoveRoleFromInstanceProfile operation. */
  case object RemoveRoleFromInstanceProfile extends IdentityManagementAction

  /** Action for the RemoveUserFromGroup operation. */
  case object RemoveUserFromGroup extends IdentityManagementAction

  /** Action for the ResyncMFADevice operation. */
  case object ResyncMFADevice extends IdentityManagementAction

  /** Action for the UpdateAccessKey operation. */
  case object UpdateAccessKey extends IdentityManagementAction

  /** Action for the UpdateAccountPasswordPolicy operation. */
  case object UpdateAccountPasswordPolicy extends IdentityManagementAction

  /** Action for the UpdateAssumeRolePolicy operation. */
  case object UpdateAssumeRolePolicy extends IdentityManagementAction

  /** Action for the UpdateGroup operation. */
  case object UpdateGroup extends IdentityManagementAction

  /** Action for the UpdateLoginProfile operation. */
  case object UpdateLoginProfile extends IdentityManagementAction

  /** Action for the UpdateServerCertificate operation. */
  case object UpdateServerCertificate extends IdentityManagementAction

  /** Action for the UpdateSigningCertificate operation. */
  case object UpdateSigningCertificate extends IdentityManagementAction

  /** Action for the UpdateUser operation. */
  case object UpdateUser extends IdentityManagementAction

  /** Action for the UploadServerCertificate operation. */
  case object UploadServerCertificate extends IdentityManagementAction

  /** Action for the UploadSigningCertificate operation. */
  case object UploadSigningCertificate extends IdentityManagementAction
